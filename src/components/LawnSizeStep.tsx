  ...
  return (
    <div className="space-y-10 px-4 max-w-5xl mx-auto">
      ...
      <div className="text-center">
        <p className="text-lg font-medium text-gray-800 mb-4">Do you know your lawn size?</p>
      ...
      {knowledgeMode === 'unknown' && (
        <div className="border-t border-gray-200 pt-6 animate-fade-in">
          <div className="text-center max-w-md mx-auto">
            <Label className="text-base font-medium text-gray-900">Lawn Size (square feet)</Label>
            <Input
              type="number"
              value={customSize}
              onChange={(e) => {
